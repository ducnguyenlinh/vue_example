  ...
  <div class="product">
    <div :class="'product-inner ' + product.color">
      ...
      <div class="product-detail">
        <h2>{{ product.title }}</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos dolore facere illum ipsum porro provident quae quisquam ratione soluta voluptates.</p>
      </div>
    </div>
  </div>
</template>
